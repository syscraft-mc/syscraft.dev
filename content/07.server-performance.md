...
## What is / how do I read a Timings report?

While we do not have a guide yet, consider watching [Aikar's video on how to read Timings v2](https://www.youtube.com/watch?v=T4J0A9l7bfQ)!

If you are using [Paper](https://papermc.io/) (or a fork of it) you can access Timings V2, which is a massively improved monitoring system of your server that allows you to see where your resources are going. It is highly recommended to get a base understanding of how timings work as they can help determine lag sources. You can learn about what it does and how to use it [here](https://www.youtube.com/watch?v=T4J0A9l7bfQ) and learn about it’s uses and limitations [here](https://madelinemiller.dev/blog/timings-performance-guide/)!
