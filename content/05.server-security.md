...
A guide from Digital Ocean on setting up Public Key authentication and disabling password authentication for Ubuntu, Debian, or CentOS can be found [here](https://www.digitalocean.com/community/tutorials/how-to-set-up-ssh-keys-on-ubuntu-20-04). If you use a VPS/Dedicated Server, don’t run your server as root. Give each server it’s own Linux user on the system.
